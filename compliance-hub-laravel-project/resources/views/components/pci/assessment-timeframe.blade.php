<div class="bg-white shadow rounded-lg p-6 mb-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
            ...
            <div x-show="!isEditing" class="mt-1 font-semibold text-gray-800" x-text="details.date_of_report || 'Not set'"></div>
        ...
        <div>
            ...
            <div x-show="!isEditing" class="mt-1 font-semibold text-gray-800" x-text="details.date_assessment_ended || 'Not set'"></div>
            <div x-show="isEditing">
