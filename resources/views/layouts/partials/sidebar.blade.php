    ...
    <div class="flex flex-col w-64">
        ...
        <div class="h-0 flex-1 flex flex-col overflow-y-auto bg-gray-800">
            <nav class="flex-1 px-2 py-4 space-y-1">
                ...
                <a href="#" class="text-gray-500 group flex items-center px-2 py-2 text-sm font-medium rounded-md cursor-not-allowed" aria-disabled="true" onclick="return false;">
