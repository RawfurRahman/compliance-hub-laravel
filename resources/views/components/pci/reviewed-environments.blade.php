...
<div class="bg-white shadow rounded-lg p-6 mb-8">
    ...
    <div class="space-y-6">
        <div>
            ...
            <div x-show="!isEditing" class="mt-1 p-2 bg-gray-50 rounded-md border">{{ optional($details)->network_diagrams_desc ?: 'Not provided.' }}</div>
        ...
        <div>
            ...
            <div x-show="!isEditing" class="mt-1 p-2 bg-gray-50 rounded-md border">{{ optional($details)->account_dataflow_diagrams_desc ?: 'Not provided.' }}</div>
        ...
        <div>
            ...
            <div x-show="!isEditing" class="mt-1 p-2 bg-gray-50 rounded-md border">{{ optional($details)->storage_account_data_desc ?: 'Not provided.' }}</div>
        ...
        <hr class="my-6">
        <div x-data="{ tpsps: {{ json_encode(optional($details)->tpsps ?? []) }} }">
            ...
            <table class="min-w-full divide-y divide-gray-300 assessment-table">
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                    <template x-for="(tpsp, index) in tpsps" :key="index">
                        <tr>
                            ...
                            <td x-show="isEditing"><button type="button" @click="tpsps.splice(index, 1)" class="text-red-600">Remove</button></td>
                        </tr>
                    </template>
                </tbody>
            </table>
            <button type="button" @click="tpsps.push({ name: '', service_provided: '' })" class="mt-2 text-blue-600" x-show="isEditing">Add Provider</button>
        </div>
        <div x-data="{ networks: {{ json_encode(optional($details)->networks ?? []) }} }" class="mt-6">
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                    <template x-for="(network, index) in networks" :key="index">
                        <tr>
                            ...
                            <td x-show="isEditing"><button type="button" @click="networks.splice(index, 1)" class="text-red-600">Remove</button></td>
                        </tr>
                    </template>
                </tbody>
            </table>
            <button type="button" @click="networks.push({ name: '', ip_range: '' })" class="mt-2 text-blue-600" x-show="isEditing">Add Network</button>
        </div>
        <div x-data="{ locations: {{ json_encode(optional($details)->locations ?? []) }} }" class="mt-6">
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                    <template x-for="(location, index) in locations" :key="index">
                        <tr>
                            ...
                            <td x-show="isEditing"><button type="button" @click="locations.splice(index, 1)" class="text-red-600">Remove</button></td>
                        </tr>
                    </template>
                </tbody>
            </table>
            <button type="button" @click="locations.push({ name: '', address: '' })" class="mt-2 text-blue-600" x-show="isEditing">Add Location</button>
        </div>
        <div x-data="{ components: {{ json_encode(optional($details)->components ?? []) }} }" class="mt-6">
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                    <template x-for="(component, index) in components" :key="index">
                        <tr>
                            ...
                            <td x-show="isEditing"><button type="button" @click="components.splice(index, 1)" class="text-red-600">Remove</button></td>
                        </tr>
                    </template>
                </tbody>
            </table>
            <button type="button" @click="components.push({ name: '', type: '' })" class="mt-2 text-blue-600" x-show="isEditing">Add Component</button>
        </div>
    </div>
</div>
