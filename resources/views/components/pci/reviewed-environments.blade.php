<div class="bg-white shadow rounded-lg p-6 mb-8">
    ...
    <div class="space-y-6">
        ...
        <!-- Account Dataflow Diagrams Description -->
        <div>
        ...
        <!-- Storage of Account Data Description -->
        <div>
        ...
        <!-- In-scope Third-Party Service Providers (TPSPs) -->
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                    <template x-for="(tpsp, index) in details.tpsps" :key="index">
                        <tr>
                            ...
                            <td x-show="isEditing"><button type="button" @click="details.tpsps.splice(index, 1)" class="text-red-600 hover:text-red-900">Remove</button></td>
                        </tr>
                    </template>
                </tbody>
            </table>
            <button type="button" @click="details.tpsps.push({ name: '', service_provided: '' })" class="mt-2 text-blue-600 hover:text-blue-900" x-show="isEditing">Add Provider</button>
        </div>
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                    <template x-for="(network, index) in details.networks" :key="index">
                        <tr>
                            ...
                            <td x-show="isEditing"><button type="button" @click="details.networks.splice(index, 1)" class="text-red-600 hover:text-red-900">Remove</button></td>
                        </tr>
                    </template>
                </tbody>
            </table>
            <button type="button" @click="details.networks.push({ name: '', ip_range: '' })" class="mt-2 text-blue-600 hover:text-blue-900" x-show="isEditing">Add Network</button>
        </div>
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                    <template x-for="(location, index) in details.locations" :key="index">
                        <tr>
                            ...
                            <td x-show="isEditing"><button type="button" @click="details.locations.splice(index, 1)" class="text-red-600 hover:text-red-900">Remove</button></td>
                        </tr>
                    </template>
                </tbody>
            </table>
            <button type="button" @click="details.locations.push({ name: '', address: '' })" class="mt-2 text-blue-600 hover:text-blue-900" x-show="isEditing">Add Location</button>
        </div>
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                    <template x-for="(component, index) in details.components" :key="index">
                        <tr>
                            ...
                            <td x-show="isEditing"><button type="button" @click="details.components.splice(index, 1)" class="text-red-600 hover:text-red-900">Remove</button></td>
                        </tr>
                    </template>
                </tbody>
            </table>
            <button type="button" @click="details.components.push({ name: '', type: '' })" class="mt-2 text-blue-600 hover:text-blue-900" x-show="isEditing">Add Component</button>
        </div>
    </div>
</div>
