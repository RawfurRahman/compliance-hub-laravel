...
<div class="bg-white shadow rounded-lg p-6 mb-8">
    ...
    <div class="space-y-6">
        <div>
            ...
            <div x-show="!isEditing" class="mt-1 p-2 bg-gray-50 rounded-md border">{{ optional($details)->scope_validation_activities ?: 'Not provided.' }}</div>
        ...
        <div>
            ...
            <div x-show="!isEditing" class="mt-1 p-2 bg-gray-50 rounded-md border">{{ optional($details)->scope_excluded_areas ?: 'Not provided.' }}</div>
            <div x-show="isEditing">
        ...
        <div>
            ...
            <div x-show="!isEditing" class="mt-1 p-2 bg-gray-50 rounded-md border">{{ optional($details)->scope_reduction_factors ?: 'Not provided.' }}</div>
            <div x-show="isEditing">
        ...
        <div>
            ...
            <div x-show="!isEditing" class="mt-1 p-2 bg-gray-50 rounded-md border">{{ optional($details)->saq_eligibility ?: 'Not provided.' }}</div>
            <div x-show="isEditing">
