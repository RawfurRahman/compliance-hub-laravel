...
/**
 * History table for financial exposure metrics, suitable for trend reporting.
 *
 * One row per (project, scope) per snapshot. scope = 'portfolio' for the
 * project-wide rollup, or 'category:<name>' for a category-level rollup.
 */
