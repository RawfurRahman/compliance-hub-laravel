...
class FrameworkControl extends Model
{
    ...
    /**
     * Get control name dynamically from description or hardcoded lookup.
     */
    public function getControlNameAttribute()
    {
        // 1. Check hardcoded list first (e.g. for ISO 27001)
        $hardcoded = self::getHardcodedControlName($this->control_id);
        if ($hardcoded) {
            return $hardcoded;
        }

        // 2. Try to parse from requirement_description
        $desc = $this->requirement_description;
    ...
    /**
     * Helper to get official ISO 27001:2022 control names.
     */
