...
class RiskExceptionRequest extends Model
{
    protected $table = 'risk_exception_requests';
    protected $fillable = [
        'risk_register_id', 'requested_by', 'approved_by',
        'reason', 'compensating_controls', 'expiry_date', 'status', 'approver_notes', 'decided_at',
    ];
